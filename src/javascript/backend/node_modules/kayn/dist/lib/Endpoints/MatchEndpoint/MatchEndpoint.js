...
class MatchEndpoint extends _MatchSuperclass2.default {
    ...
    listMatchIDs(tournamentCode) {
        return new _Request2.default(this.config, this.serviceName, `matches/by-tournament-code/${tournamentCode}/ids`, _methodNames2.default.MATCH.GET_MATCH_IDS_BY_TOURNAMENT_CODE, 'GET', this.limiter);
    }
    ...
    getTournamentMatch(matchID, tournamentCode) {
        return new _Request2.default(this.config, this.serviceName, `matches/${matchID}/by-tournament-code/${tournamentCode}`, _methodNames2.default.MATCH.GET_MATCH_BY_TOURNAMENT_CODE, 'GET', this.limiter);
    }
}
