...
class CurrentGameEndpoint extends _SpectatorSuperclass2.default {
    ...
    summonerID(summonerID) {
        return new _Request2.default(this.config, this.serviceName, `active-games/by-summoner/${summonerID}`, _methodNames2.default.SPECTATOR.GET_CURRENT_GAME_INFO_BY_SUMMONER, 'GET', this.limiter);
    }
}

exports.default = CurrentGameEndpoint;