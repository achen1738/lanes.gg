...
function main(kayn) {
    kayn.ChampionRotation.list().callback(function (error1, res1) {
        if (!error1) {
            kayn.DDragon.Champion.list().version('8.15.1').callback(function (error2, res2) {
                if (!error2) {
