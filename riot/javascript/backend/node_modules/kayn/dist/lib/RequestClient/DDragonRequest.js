...
function DDragonRequest(config, endpoint, requestType, methodName, dataTransformer) {
    this.payload = {
        endpoint,
        version: '',
        locale: '',
...
DDragonRequest.prototype.region = function (region) {
...
DDragonRequest.prototype.catch = callback => undefined.then(null, callback);

DDragonRequest.prototype.callback = (() => {
...
DDragonRequest.prototype.execute = (() => {
    var _ref2 = _asyncToGenerator(function* (url, isRealmPreRequest, cb) {
        var _this2 = this;
                ...
                try {
                    if (data) {
                        ...
                        try {
                            ...
                            const transformedBlob = _this2.dataTransformer && !isRealmPreRequest ? _this2.dataTransformer(blob) : blob;
                            if (cacheOptions.cache && cacheOptions.ttls[_this2.methodName] > 0) {
                                cacheOptions.cache.set({
                                    key: url,
                                    ttl: cacheOptions.ttls[_this2.methodName]
                                }, transformedBlob);
                                if (debugOptions.isEnabled) {
