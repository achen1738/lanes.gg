...
class MasterEndpoint extends _LeagueSuperclass2.default {
     ...
     */
    list(queueName) {
        return new _Request2.default(this.config, this.serviceName, `masterleagues/by-queue/${queueName}`, _methodNames2.default.LEAGUE.GET_MASTER_LEAGUE, 'GET', this.limiter);
    }
}

exports.default = MasterEndpoint;