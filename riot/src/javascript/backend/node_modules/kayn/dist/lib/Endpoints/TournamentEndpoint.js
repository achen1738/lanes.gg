...
class TournamentEndpoint extends _Endpoint2.default {
    ...
    createTournamentCode(tournamentID, body) {
        return new _Request2.default(this.config, this.serviceName, 'codes', _methodNames2.default.TOURNAMENT.CREATE_TOURNAMENT_CODE, 'POST', this.limiter, body, true).query({ tournamentId: tournamentID });
    }
    ...
    updateTournamentCode(tournamentCode, body) {
        ...
        return new _Request2.default(this.config, this.serviceName, `codes/${tournamentCode}`, _methodNames2.default.TOURNAMENT.UPDATE_TOURNAMENT_CODE, 'PUT', this.limiter, body, true);
    }
    ...
    getTournamentByCode(tournamentCode) {
        return new _Request2.default(this.config, this.serviceName, `codes/${tournamentCode}`, _methodNames2.default.TOURNAMENT.GET_TOURNAMENT_CODE, 'GET', this.limiter, null, true);
    }
    ...
    register(providerID, name = '') {
        ...
        return new _Request2.default(this.config, this.serviceName, 'tournaments', _methodNames2.default.TOURNAMENT.REGISTER_TOURNAMENT, 'POST', this.limiter, body, true);
    }
    ...
    registerProviderData(region = this.config.region.toUpperCase(), url) {
        ...
        return new _Request2.default(this.config, this.serviceName, 'providers', _methodNames2.default.TOURNAMENT.REGISTER_PROVIDER_DATA, 'POST', this.limiter, body, true);
    }
    ...
    lobbyEvents(tournamentCode) {
        return new _Request2.default(this.config, this.serviceName, `lobby-events/by-code/${tournamentCode}`, _methodNames2.default.TOURNAMENT.GET_LOBBY_EVENTS_BY_CODE, 'GET', this.limiter, null, true);
    }
}

exports.default = TournamentEndpoint;