...
<html lang="en">
<head>
    <title>Code coverage report for lib/Endpoints/ChampionMasteryEndpointV4.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">all files</a> / <a href="index.html">lib/Endpoints/</a> ChampionMasteryEndpointV4.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
     ...
     *
     * Implements GET `/lol/champion-mastery/v3/champion-masteries/by-summoner/{encryptedSummonerId}`.
     *
     * @param {string} summonerID - The ID of the summoner.
     */
    list(summonerID) {
...
&nbsp;
     ...
     * Get all champion mastery entries sorted by number of champion points descending.
     *
     * Implements GET `/lol/champion-mastery/v3/scores/by-summoner/{encryptedSummonerId}`.
     *
