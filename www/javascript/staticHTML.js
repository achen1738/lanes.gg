...
function addLanes(timelineObj, win, version, place, images, actualContainer, lanes) {
...
function addRunes(container, version, summoner) {
...
function addBuildSkills(container, version, summoner, skillArray) {
 ...
 *                        single player
 */
function addBuildItems(container, version, summItems) {
 ...
 */
function addBuilds(summName, container, version, match, timelineObj) {
 ...
 */
function addOverview(container, match, runes, items, win, place, champURL) {
